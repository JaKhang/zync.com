...
public record CreateImageCommand(ZID id, ZID uploadBy, List<Variant> variants, long size, String reference, boolean uploaded, Dimension dimension, MediaType mediaType) implements MediatorRequest<ZID> {
}
